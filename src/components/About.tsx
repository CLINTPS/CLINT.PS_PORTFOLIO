            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-4 text-sm leading-relaxed text-gray-500 font-medium">
                <p>
                  ...
                  . I focus on performance-driven development, clean
                  architecture, and real-world problem solving.
                </p>

                <p>
                  I create responsive, user-friendly interfaces and robust
                  backend systems using modern technologies including REST APIs,
                  authentication, and real-time features — ensuring both
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4">
                {[
                  ...
                  { icon: <Rocket size={14} />, label: "Scalable Apps" },
                  { icon: <Coffee size={14} />, label: "Problem Solver" },
                  { icon: <Code2 size={14} />, label: "MERN + Mobile" },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-slate-400 hover:text-[var(--text-main)] transition"
                  >
            ...
            <div className="bg-[#007787] p-8 sm:p-10 rounded-2xl text-white shadow-lg relative overflow-hidden group">
              <div className="relative z-10 flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <p className="text-2xl md:text-3xl font-black italic">20+</p>
                </div>
              </div>
